...
var Ctrl = module.exports = 
  function($scope, $routeParams, $element, userData, models, state, auth, events, pages, $location, $templateCache, $http, $user, setupUserRepo) {
    ...
    _.extend(this, {
      ...
      init: function() {
        ...
        if (!this.newFile) {
          ...
          this.initData();
          console.log('writeContent', this.data.content);
          this.writeContent(this.data.content);
          this.stashApply();
...
Ctrl.$inject = ['$scope', '$routeParams', '$element', 'editorUserData', 'editorModels', 'editorState', "editorAuth", 'editorEvents', 'pages', '$location', '$templateCache', '$http', 'user', 'setupUserRepo']
