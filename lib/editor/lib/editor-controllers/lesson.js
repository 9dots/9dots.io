...
var Ctrl = module.exports = function($scope, $element, $injector) {
  ...
  this.sections = [
    ...
    {title: 'Introduce', body: 'Hook, goals, and proect introduction...'}, 
    {title: 'Explore', body: 'Brief unguided exploration...'},
    {title: 'Inquire', body: 'Guided questions and research...'},
    {title: 'Innovate', body: 'New knowledge is used to create...'},
    {title: 'Discuss', body: 'Discussion questions...'}
  ];
