...
var Ctrl = module.exports = function($scope, $element, $injector) {
  ...
  this.sections = [
    {title: 'Setup', placeholder: 'Materials and prep...'},
    {title: 'Introduce', placeholder: 'Hook, goals, and project introduction...'}, 
    {title: 'Explore', placeholder: 'Brief unguided exploration...'},
    {title: 'Inquire', placeholder: 'Guided questions and research...'},
    {title: 'Innovate', placeholder: 'New knowledge is used to create...'},
    {title: 'Discuss', placeholder: 'Discussion questions...'}
  ];
