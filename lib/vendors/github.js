  ...
  Github = window.Github = function(options) {
    ...
    Github.Repository = function(options) {
      ...
      function updateTree(branch, cb, force) {
        console.log('cached tree', currentTree);
      ...
      this.updateTree = function(baseTree, path, blob, cb) {
        console.log('updateTree', baseTree, path);
        var data = {
          "base_tree": baseTree,
          "tree": [
            {
      ...
      this.updateHead = function(head, commit, cb) {
        console.log('updateHead', head, commit);
      ...
      this.contents = function(branch, path, cb) {
        console.log('contents', branch, path);
